...
data class Plant (override val position: Point) : AquariumObject {
    ...
    @Eg(construct = arrayOf("new com.vocalabs.aquarium.Point(4, 4)"),
            ...
            returns = "new com.vocalabs.aquarium.UpdateResult(java.util.Collections.emptySet(), new com.vocalabs.aquarium.Plant(new com.vocalabs.aquarium.Point(4, 4)), new com.vocalabs.aquarium.Plant(new com.vocalabs.aquarium.Point(4, 4)))")
    @Eg(construct = arrayOf("new com.vocalabs.aquarium.Point(5, 5)"),
            ...
            returns = "new com.vocalabs.aquarium.UpdateResult(java.util.Collections.emptySet(), new com.vocalabs.aquarium.Plant(new com.vocalabs.aquarium.Point(5, 5)), new com.vocalabs.aquarium.Plant(new com.vocalabs.aquarium.Point(5, 5)))")
